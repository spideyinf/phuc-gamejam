...
const typography: some = {
  ...
  h4: { fontSize: 34, lineHeight: '48px', fontWeight: 'bold', color: WHITE, textTransform: 'uppercase', marginBottom: 24 },
  h5: { fontSize: 24, lineHeight: '34px', fontWeight: 'bold', color: WHITE, textTransform: 'uppercase', marginBottom: 24 },
  h6: { fontSize: 20, lineHeight: '32px', fontWeight: 500, textTransform: 'uppercase' },
