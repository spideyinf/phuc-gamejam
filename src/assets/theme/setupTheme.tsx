...
const typography: some = {
  ...
  h4: { fontSize: 34, lineHeight: '48px', fontWeight: 600, color: WHITE, textTransform: 'uppercase', margin: '24px 0' },
  h5: { fontSize: 24, lineHeight: '34px', fontWeight: 600, color: WHITE, textTransform: 'uppercase', margin: '24px 0' },
  h6: { fontSize: 20, lineHeight: '32px', fontWeight: 600, textTransform: 'uppercase' },
